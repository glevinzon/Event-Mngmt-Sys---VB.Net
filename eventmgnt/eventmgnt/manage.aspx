<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="manage.aspx.vb" Inherits="eventmgnt.manage" %>
                  ...
                  <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" CssClass="table table-responsive table-striped"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                    <asp:GridView ID="gvOrders" runat="server" AutoGenerateColumns="false" CssClass = "table" OnRowDataBound="grid_RowDataBound">
                                        <Columns>
                                            <asp:BoundField ItemStyle-Width="150px" DataField="attendeeId" HeaderText="Record No." />
                            ...
                            <ItemTemplate>      
                                                <a href='<%# "viewprofile.aspx?uname=" + Convert.ToString(Eval("userName"))%>'  class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
                                                <a href="<%# "deleteparticipant.aspx?attendeeId=" + Convert.ToString(Eval("attendeeId"))%>" class="btn btn-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Action"> 
                            ...
                            <ItemTemplate>      
                                                <a href='<%# "view.aspx?eventId=" + Convert.ToString(Eval("eventId"))%>'  class="btn btn-info" data-toggle="tooltip" data-placement="left" title="View"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
                                                <a href='<%# "editevent.aspx?eventId=" + Convert.ToString(Eval("eventId"))%>'  class="btn btn-warning" data-toggle="tooltip" data-placement="left" title="Edit"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                                <a href="<%# "deleteevent.aspx?eventId=" + Convert.ToString(Eval("eventId"))%>"  class="btn btn-danger" data-toggle="tooltip" data-placement="left" title="Delete"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                                                <a href='<%# "guest.aspx?eventId=" + Convert.ToString(Eval("eventId"))%>'  class="btn btn-info" data-toggle="tooltip" data-placement="left" title="Guests"><span class="glyphicon glyphicon-list" aria-hidden="true"></span></a>
