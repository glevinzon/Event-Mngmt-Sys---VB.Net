<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="addevent.aspx.vb" Inherits="eventmgnt.addevent" %>
        ...
        <div class="container">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h1 style="font-family: great_vibesregular;">Create an Event</h1>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <div style="margin: 20px">
                                    ...
                                    <div class="col-sm-2">
                                        <asp:Button runat="server" class="btn btn-primary" ID="cmd_Upload" Text="Create Event" OnClick="cmd_Upload_Click" />
                                    </div>
                                </div>
                            </ContentTemplate>
                            <Triggers>
